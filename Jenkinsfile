pipeline {
    ...
    parameters {
        ...
        string(name: 'GIT_BRANCH', defaultValue: 'python-flask-webapp', description: 'Git branch')
        string(name: 'DOCKER_REPO', defaultValue: 'docker.io/optitcloud', description: 'Docker Container Registry')
        string(name: 'DOCKER_IMAGE', defaultValue: 'python-flask-webapp', description: 'Docker Image Name')
