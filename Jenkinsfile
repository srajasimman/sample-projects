pipeline {
    ...
    parameters {
        ...
        string(name: 'GIT_BRANCH', defaultValue: 'java-springboot-gradle', description: 'Git branch')
        string(name: 'DOCKER_REPO', defaultValue: 'docker.io/optitcloud', description: 'Docker Container Registry')
        string(name: 'DOCKER_IMAGE', defaultValue: 'java-springboot-gradle', description: 'Docker Image Name')
